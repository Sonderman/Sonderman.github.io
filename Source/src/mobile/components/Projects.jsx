                    ...
                    <AnimatePresence>
                        {filteredProjects.map((project, index) => (
                            <motion.div
                                ...
                                className="group bg-card rounded-2xl overflow-hidden hover:shadow-[0_0_30px_rgba(0,0,0,0.5)] transition-all duration-300 border border-slate-800 hover:border-primary/50 relative top-0 hover:-top-2 cursor-pointer"
                            >
                                <div className="relative overflow-hidden aspect-video bg-navy">
                                    ...
                                    {/* Overlay indicator for click */}
                                    <div className="absolute inset-0 bg-black/30 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                                         <span className="text-white bg-black/50 px-4 py-2 rounded-full backdrop-blur-sm border border-white/20 text-sm font-medium">
                                            View Details
                                         </span>
                                    </div>
                                </div>
