            ...
            <div className="bg-[#1e1e1e] p-8 border-l-4 border-[#ff9e64] shadow-lg rounded max-w-md w-full relative">
                ...
                <div className="flex">
                    ...
                    <div className="text-sm leading-7 font-mono w-full">
                        ...
                        &nbsp;&nbsp;<span className="text-[#9cdcfe]">website</span>: <a href={personalData.contact.socials.find(s => s.name === 'GitHub')?.url} target="_blank" rel="noopener noreferrer" className="text-[#ce9178] hover:underline hover:text-[#ff9e64] transition-colors">'sonderman.github.io'</a><span className="text-[#d4d4d4] ;">;</span><br/>
                        ...
                        &nbsp;&nbsp;<span className="text-[#9cdcfe]">github</span>: <a href={personalData.contact.socials.find(s => s.name === 'GitHub')?.url} target="_blank" rel="noopener noreferrer" className="text-[#ce9178] hover:underline hover:text-[#ff9e64] transition-colors">'{personalData.contact.socials.find(s => s.name === 'GitHub')?.url.replace('https://', '')}'</a><span className="text-[#d4d4d4] ;">;</span><br/>
